...
public class ParameterizedTestSupport {
    ...
    {
        return Stream.of(
            Arguments.of("Integer", Integer.class, 42), Arguments.of("Float", Float.class, 3.14f),
            Arguments.of("Double", Double.class, 2.718281828),
            Arguments.of("String", String.class, "TestString"), Arguments.of("Boolean", Boolean.class, true));
    }
    ...
    {
        return Stream.of(Arguments.of(H5TestFile.NAME_DATASET_INT, "integer"),
    ...
    {
        return Stream.of(Arguments.of(1, "single element"), Arguments.of(10, "small array"),
                         Arguments.of(100, "medium array"), Arguments.of(1000, "large array"));
    }
    ...
    {
        return Stream.of(Arguments.of("HDF5", ".h5", "Standard HDF5 format"),
    ...
    {
        return Stream.of(Arguments.of("null_file", NullPointerException.class),
    ...
    {
        return Stream.of(Arguments.of(new long[] {10}, "1D array"),
    ...
    {
        return Stream.of(Arguments.of(0, "zero"), Arguments.of(1, "minimum positive"),
