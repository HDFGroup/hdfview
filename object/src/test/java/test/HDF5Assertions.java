    ...
    public static void assertDatasetExists(H5File file, String datasetName) {
        ...
        try {
            ...
            assertTrue(obj instanceof Dataset,
                () -> String.format("Object '%s' should be a Dataset, but was %s",
                    datasetName, obj.getClass().getSimpleName()));
        } catch (Exception ex) {
    ...
    public static void assertGroupExists(H5File file, String groupName) {
        ...
        try {
            ...
            assertTrue(obj instanceof Group,
                () -> String.format("Object '%s' should be a Group, but was %s",
                    groupName, obj.getClass().getSimpleName()));
        } catch (Exception ex) {
