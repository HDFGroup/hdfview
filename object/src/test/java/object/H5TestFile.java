...
public class H5TestFile {
    ...
    public static final String OBJ_NAMES[] = {NAME_GROUP,
                                              NAME_GROUP_ATTR,
                                              NAME_GROUP_SUB,
                                              NAME_DATASET_INT,
                                              NAME_DATASET_FLOAT,
    ...
    public static final int OBJ_TYPES[] = {
        HDF5Constants.H5O_TYPE_GROUP,          HDF5Constants.H5O_TYPE_GROUP,
        HDF5Constants.H5O_TYPE_GROUP,          HDF5Constants.H5O_TYPE_DATASET,
        HDF5Constants.H5O_TYPE_DATASET,        HDF5Constants.H5O_TYPE_DATASET,
        HDF5Constants.H5O_TYPE_DATASET,        HDF5Constants.H5O_TYPE_DATASET,
        HDF5Constants.H5O_TYPE_DATASET,        HDF5Constants.H5O_TYPE_DATASET,
        HDF5Constants.H5O_TYPE_DATASET,        HDF5Constants.H5O_TYPE_DATASET,
        HDF5Constants.H5O_TYPE_DATASET,        HDF5Constants.H5O_TYPE_NAMED_DATATYPE,
    ...
    public static final H5File createTestFile(String fileName) throws Exception
    {
        ...
        final H5Datatype typeInt =
            new H5Datatype(Datatype.CLASS_INTEGER, DATATYPE_SIZE, Datatype.NATIVE, Datatype.NATIVE);
        final H5Datatype typeByte =
            new H5Datatype(Datatype.CLASS_INTEGER, 1, Datatype.NATIVE, Datatype.SIGN_NONE);
        final H5Datatype typeFloat =
            new H5Datatype(Datatype.CLASS_FLOAT, DATATYPE_SIZE, Datatype.NATIVE, Datatype.NATIVE);
        final H5Datatype typeStr =
        ...
        final H5Datatype typeEnum =
            new H5Datatype(Datatype.CLASS_ENUM, DATATYPE_SIZE, Datatype.NATIVE, Datatype.NATIVE);
        typeEnum.setEnumMembers("0=1,1=2");
        log.trace("create reference type");
        final H5Datatype typeRef =
            new H5Datatype(Datatype.CLASS_REFERENCE, Datatype.NATIVE, Datatype.NATIVE, Datatype.NATIVE);

        log.trace("create compound types");
        COMPOUND_MEMBER_DATATYPES[0] =
            new H5Datatype(Datatype.CLASS_INTEGER, DATATYPE_SIZE, Datatype.NATIVE, Datatype.NATIVE);
        COMPOUND_MEMBER_DATATYPES[1] =
            new H5Datatype(Datatype.CLASS_FLOAT, DATATYPE_SIZE, Datatype.NATIVE, Datatype.NATIVE);
        COMPOUND_MEMBER_DATATYPES[2] =
            new H5Datatype(Datatype.CLASS_STRING, STR_LEN, Datatype.NATIVE, Datatype.NATIVE);
        COMPOUND_MEMBER_DATATYPES[3] =
            new H5Datatype(Datatype.CLASS_INTEGER, DATATYPE_SIZE, Datatype.NATIVE, Datatype.SIGN_NONE);
        ...
        // attributes
        ATTRIBUTE_STR =
            new H5ScalarAttr(g1, "strAttr", typeStr, new long[] {1}, new String[] {"String attribute."});
        ...
        dsets[1] =
            file.createScalarDS(NAME_DATASET_FLOAT, null, typeFloat, DIMs, null, CHUNKs, 9, DATA_FLOAT);
        ...
        dsets[6] = file.createScalarDS(NAME_DATASET_FLOAT_SUB_SUB, g00, typeFloat, DIMs, null, CHUNKs, 9,
                                       DATA_FLOAT);
        dsets[7] =
            file.createImage(NAME_DATASET_IMAGE, null, typeByte, DIMs, null, CHUNKs, 9, 1, -1, DATA_BYTE);
        ...
        dsets[9] = file.createCompoundDS(NAME_DATASET_COMPOUND_SUB, null, DIMs, null, CHUNKs, 9,
                                         COMPOUND_MEMBER_NAMES, COMPOUND_MEMBER_DATATYPES, null, DATA_COMP);
        dsets[10] =
            file.createScalarDS(NAME_DATASET_OBJ_REF, null, typeRef, DIMREFs, null, CHUNKREFs, 9, null);

        // attach attributes to all datasets
        log.trace("attach attributes");
        for (int i = 0; i < dsets.length; i++) {
            ATTRIBUTE_STR       = new H5ScalarAttr(dsets[i], "strAttr", typeStr, new long[] {1},
        ...
        final Dataset pal  = file.createScalarDS(NAME_DATASET_IMAGE_PALETTE, null, typeByte,
                                                 new long[] {256, 3}, null, null, -1, DATA_PALETTE);
        ...
        Datatype dnative =
            file.createDatatype(Datatype.CLASS_INTEGER, DATATYPE_SIZE, Datatype.NATIVE, Datatype.NATIVE);
        Datatype dtype = file.createNamedDatatype(dnative, NAME_DATATYPE_INT);
        ATTRIBUTE_STR =
            new H5ScalarAttr(dtype, "strAttr", typeStr, new long[] {1}, new String[] {"String attribute."});
        ...
        dnative =
            file.createDatatype(Datatype.CLASS_INTEGER, DATATYPE_SIZE, Datatype.NATIVE, Datatype.SIGN_NONE);
        ...
        //  (int i = 0; i < OBJ_NAMES.length; i++) { --//This gives CORE DUMP when OBJ_NAMES =
        //  NAME_DATASET_OBJ_REF,
