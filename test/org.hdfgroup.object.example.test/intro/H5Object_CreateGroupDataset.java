...
public class H5Object_CreateGroupDataset {
    ...
    private static void h5_crtgrpd()
    {
        ...
        try {
            dset = file.createScalarDS("/" + GROUPNAME + "/" + DATASETNAME1, grp, typeInt, dims1, null, null,
                                       0, dset1_data);
        }
        catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            dset = file.createScalarDS("/" + GROUPNAME + "/" + DATASETNAME2, grp, typeInt, dims2, null, null,
                                       0, dset2_data);
        }
        catch (Exception e) {
            e.printStackTrace();
    ...
    public static void main(String[] args) { H5Object_CreateGroupDataset.h5_crtgrpd(); }
}
