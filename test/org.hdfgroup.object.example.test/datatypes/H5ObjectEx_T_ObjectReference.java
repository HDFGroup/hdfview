...
public class H5ObjectEx_T_ObjectReference {
    ...
    enum H5O_TYPE_obj {
        ...
        H5O_TYPE_obj(int layout_type) { this.code = layout_type; }

        public int getCode() { return this.code; }

        public static H5O_TYPE_obj get(int code) { return lookup.get(code); }
    }
    ...
    private static void writeObjRef()
    {
        ...
        try {
            ...
            // Create the dataset.
            try {
                dset = (H5ScalarDS)file.createScalarDS(DATASETNAME, null, typeRef, dims, null, null, 0,
                                                       dset_data);
            }
            catch (Exception e) {
                e.printStackTrace();
