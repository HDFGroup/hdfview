...
@RunWith(Suite.class)
@Suite.SuiteClasses({// hdf.object.h5 package
                     H5CompoundDSTest.class, H5BugFixTest.class, H5ScalarDSTest.class, H5GroupTest.class,
                     H5DatatypeTest.class, H5FileTest.class,
