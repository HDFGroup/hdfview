...
public class NC2Datatype extends Datatype {
     ...
     * NC2Datatype type = new H4Dataype(Datatype.CLASS_INTEGER, Datatype.NATIVE, Datatype.NATIVE, Datatype.SIGN_NONE);</li>
     * <li>to create 16-bit signed integer with big endian<br>
     * NC2Datatype type = new H4Dataype(Datatype.CLASS_INTEGER, 2, Datatype.ORDER_BE, Datatype.NATIVE);</li>
     * <li>to create native float<br>
     * NC2Datatype type = new H4Dataype(Datatype.CLASS_FLOAT, Datatype.NATIVE, Datatype.NATIVE, Datatype.NATIVE);</li>
     * <li>to create 64-bit double<br>
     * NC2Datatype type = new H4Dataype(Datatype.CLASS_FLOAT, 8, Datatype.NATIVE, Datatype.NATIVE);</li>
     * </ol>
     *
     * @param tclass
