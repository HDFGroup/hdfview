...
public class DefaultPaletteView extends Dialog implements PaletteView {
     ...
     */
    public DefaultPaletteView(Shell parent, ImageView theImageView) { this(parent, null, theImageView); }
    ...
    private void updatePalette()
    {
        ...
        IndexColorModel colorModel =
            new IndexColorModel(8,           // bits - the number of bits each pixel occupies
        ...
        if (memoryImageSource == null)
            memoryImageSource =
                new MemoryImageSource((int)w, (int)h, colorModel, imageView.getImageByteData(), 0, (int)w);
        else
