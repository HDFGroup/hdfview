...
public class TestHDFViewAttributes extends AbstractWindowTest {
                    ...
                    for (int row = 1; row <= 4; row++) {
                        for (int col = 1; col <= 4; col++) {
                            ...
                            table.widget.getActiveCellEditor().commit(SelectionLayer.MoveDirectionEnum.RIGHT,
                                                                      true, true);
                            assertTrue(constructWrongValueMessage("createNewDataset()", "wrong value", val,
    ...
    public SWTBotTableItem addAttributeToObject(String testname, SWTBotTable attrTable, int attrindex)
    {
        ...
        try {
            ...
            assertTrue(constructWrongValueMessage(testname, "attribute table wrong row count",
                                                  String.valueOf(attrindex),
                                                  String.valueOf(attrTable.rowCount())),
                       attrTable.rowCount() == attrindex);
            ...
            assertTrue(constructWrongValueMessage(testname, "attribute table wrong row count",
                                                  ...
                                                  String.valueOf(attrTable.rowCount())),
                       attrTable.rowCount() == attrindex + 1);
    ...
    public void deleteAttributeFromObject(String testname, SWTBotTable attrTable, SWTBotTableItem newItem,
                                          boolean useButton)
    {
    ...
    public void testHDF4RenameAttributeFunctionDisabled()
    {
        ...
        try {
            ...
            /* Add an attribute to the newly-created group */
            SWTBotTable attrTable = openAttributeTable(filetree, testFilename, groupname);
            SWTBotTableItem newItem =
                addAttributeToObject("testHDF4RenameAttributeFunctionDisabled()", attrTable, 0);
    ...
    public void testHDF4DeleteAttributeFunctionDisabled()
    {
        ...
        try {
            ...
            SWTBotTable attrTable = openAttributeTable(filetree, testFilename, groupname);
            SWTBotTableItem newItem =
                addAttributeToObject("testHDF4DeleteAttributeFunctionDisabled()", attrTable, 0);
    ...
    public void testHDF5RenameAttributeDisabledForReadOnly()
    {
        ...
        try {
            ...
            assertTrue(constructWrongValueMessage("testHDF5RenameAttributeDisabledForReadOnly()",
                                                  "rename attribute menuitem not disabled", "disabled",
                                                  "enabled"),
                       !bot.table().contextMenu().contextMenu("Rename Attribute").isEnabled());
